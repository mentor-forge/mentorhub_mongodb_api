...
container:
	...
	DOCKER_BUILDKIT=0 docker build -t ghcr.io/mentor-forge/mentorhub_mongodb_api:latest .
...
push:
	...
	@docker push ghcr.io/mentor-forge/mentorhub_mongodb_api:latest
	@echo "Pushed: ghcr.io/mentor-forge/mentorhub_mongodb_api:latest"
...
delete-package:
	...
	@gh api -X DELETE "/orgs/mentor-forge/packages/container/mentorhub_mongodb_api" 2>/dev/null || true
