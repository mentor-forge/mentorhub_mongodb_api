...
- **Dictionary file** ../configurator/dictionaries/Profile.0.1.0.yaml
- **Enumerators file** ../configurator/enumerators/enumerations.0.yaml
- **Target test‑data file** ../configurator/test_data/Profile.0.1.0.0.json`
- **Number of documents to generate**: `15`
- **Special requirements** Create one record for each identity record in test_data/Identity.0.1.0.0.json. The status of the profile should match the status of the identity. Use deterministic _id values starting with "A00000000000000000000001", "A00000000000000000000002", "A00000000000000000000003", etc. 
