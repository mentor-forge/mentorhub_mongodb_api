...
- **Number of documents to generate**: `A Lot`
- **Special requirements** Review the resources found in the following markdown files, and harvest the resources listed there. You should harvest every resource, I expect a large number of resources.
