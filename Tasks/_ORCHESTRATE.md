...
2. **For each task**, the orchestrator selects the least expensive model that can provide good results. Many tasks will not need high reasoning models. Prefer default models. Then, launch a new agent with:
   - The task file path
